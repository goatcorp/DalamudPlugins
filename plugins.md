...
|---------------|---------------|-----------------|
| Haplo064 | [Accurate CountDown](https://github.com/Haplo064/Europe) | Shows the current countdown time. |
...
| Ottermandias | [AutoVisor](https://github.com/Ottermandias/AutoVisor) | Automatically change visor, headslot hiding, and weapon hiding status for different player states, as well as default CPoses per job. |
...
| Haplo064 | [Chat Bubbles](https://github.com/Haplo064/ChatBubbles) | Enables in-game chat bubbles. |
